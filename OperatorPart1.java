public class OperatorPart1{
  public static void main(String[] args){
	...
	num1 *= num2;
	System.out.printf("The value of num1was updated to %d%n",num1);
	
	num1 %= num2;
	System.out.printf("The value of num1 was updatd to %d%n",num1);
	
	// Realtional Operator or comparison Operator
